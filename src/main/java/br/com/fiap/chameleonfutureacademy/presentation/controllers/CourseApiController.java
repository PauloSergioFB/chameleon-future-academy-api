...
@io.swagger.v3.oas.annotations.tags.Tag(name = "Cursos", description = "Endpoints para listagem, busca e consulta de informações relacionadas aos cursos.")
public class CourseApiController {
        ...
        @Operation(summary = "Listar cursos", description = "Retorna uma lista paginada de cursos, permitindo filtrar por título, autor ou descrição da tag.")
        @GetMapping
        ...
        @Operation(summary = "Buscar cursos", description = "Retorna uma lista paginada de cursos filtrados por um termo que busca por título, autor ou descrição parcial da tag. O parâmetro de tag separado exige correspondência exata e limita o resultado aos cursos que a possuem.")
        @GetMapping("/search")
        ...
        @Operation(summary = "Obter curso por ID", description = "Retorna as informações de um curso específico identificado pelo ID.")
        @GetMapping("/{id}")
        ...
        @Operation(summary = "Listar tags do curso", description = "Retorna todas as tags associadas ao curso identificado pelo ID.")
        @GetMapping("/{id}/tags")
        ...
        @Operation(summary = "Listar badges do curso", description = "Retorna todas as badges atribuídas ao curso identificado pelo ID.")
        ...
        @Operation(summary = "Listar conteúdos do curso", description = "Retorna todos os conteúdos vinculados ao curso identificado pelo ID.")
        ...
        @Operation(summary = "Obter detalhes completos do curso", description = "Retorna informações detalhadas do curso, incluindo dados complementares relacionados ao conteúdo e estrutura.")
